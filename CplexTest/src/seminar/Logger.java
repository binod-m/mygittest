...
public class Logger {
	...
	public Connection getConnectionToDB() {
		...
		try {
				...
				String db_connect_string = "jdbc:sqlserver://localhost;instance=SQLEXPRESS;databaseName=master";

		        //return DriverManager.getConnection(db_connect_string,"open_user","bell");
		        return DriverManager.getConnection(db_connect_string,"US\\LSR4PJS","");
    ...
    public static void Main(String[] args) {
    	Connection lg = new Logger().getConnectionToDB();
    	((Logger) lg).closeConnection();
